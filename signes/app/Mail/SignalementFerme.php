...
class SignalementFerme extends Mailable
{
    ...
    {
        $subject = $this->signalement->etablissement->nom." - Fermeture signalement N° ".$this->signalement->id." du ".date('d-m-Y H:i:s', strtotime($this->signalement->date));
